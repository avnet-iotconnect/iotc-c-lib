...
#ifndef IOTCL_CERTS_H
#define IOTCL_CERTS_H
...
// Valid to 31 Dec 2037
// Signature Algorithm: sha256WithRSAEncryption
// Public Key Algorithm: rsaEncryption (2048 bit)
#define IOTCL_CERT_STARFIELD_ROOT_G2 \
"-----BEGIN CERTIFICATE-----\n"\
