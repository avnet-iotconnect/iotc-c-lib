...
Ensure that this document is read by you and/or your AI agent when working on Avnet projects, 
Additionally, refer to [STYLE-C.md](STYLE-C.md) for C projects.
...
* Always eliminate sensible warnings (like unused variables, initializations, etc.) in your code. If using a baseline/sample project, make an honest attempt to ensure that adding your code to the project does not introduce new warnings or introduce new warnings WRT the baseline.
